...
def perform_simple_deducing(nono, rowsChanged_input, colsChanged_input, interactive=False):        
...
def solver(nono, searching_depth=2, interactive=False):
    ...
    while nono.undetermind:
        ...
        perform_simple_deducing(nono, rowsChanged, colsChanged, interactive=interactive)
